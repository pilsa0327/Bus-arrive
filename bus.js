...
//발급 받은 API키
const $KEY = 'xBVIMR0jOGr%2F4d190JTexinfVMwhMlG9pLSbKzVJkA8BX3IRAF67F9CxdHdtPzRAY8U%2FfqDie5DTljkp0XS7uw%3D%3D';
//조회할 정류소 ID
...
request($api_url, function(err, res, body){
   ...
   $('busArrivalList').each(function(idx){
       ...
       let predictTime2 = $(this).find('predictTime2').text();
       console.log(`도착 예정 버스: ${no1}, ${predictTime1}분 뒤 도착합니다. 다음 도착 버스: ${no2 ? no2 : '---'}. ${predictTime2}분 뒤 도착합니다.`);
                     // ` 백틱 문자
   });
